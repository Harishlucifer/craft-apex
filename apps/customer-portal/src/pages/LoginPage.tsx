  ...
  const handleLogin = async (credentials: any) => {
    try {
      ...
      login({
        id: '1',
        name: 'Customer User',
        email: credentials.mobile + '@customer.com',
        role: 'customer'
      });
        ...
        <div className="col-lg-12">
          <div className="row">
            <div className="col-lg-12" style={{ marginTop: '7vh' }}>
              <Card title="Customer Portal Login" className="overflow-hidden">
          ...
          <div className="col-lg-12">
            <div className="text-center p-3">
              <p className="mb-0 text-muted">
                © {new Date().getFullYear()} {platformConfig?.branding?.tenantName || 'Customer Portal'}. All rights reserved.
              </p>
            </div>
          </div>
        </div>
