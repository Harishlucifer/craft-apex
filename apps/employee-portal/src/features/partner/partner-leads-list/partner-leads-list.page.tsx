...
import { usePartnerLeadsList } from "./partner-leads-list.api";
...
export default function PartnerLeadsListPage() {
  const [page, setPage] = useState(1);
  const { data, isFetching } = usePartnerLeadsList(page);
    ...
    <DataTableShell
      ...
      header={
        <TableRow className={TABLE_HEADER_ROW_CLASS}>
          ...
          <TableHead className={TABLE_HEAD_CLASS}>Enterprise Name</TableHead>
          <TableHead className={TABLE_HEAD_CLASS}>Primary Contact</TableHead>
    ...
    >
      {rows.map((r, i) => (
        ...
        >
          ...
          <TableCell>{r.point_of_contact ?? "—"}</TableCell>
