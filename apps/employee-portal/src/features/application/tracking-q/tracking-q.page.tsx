...
import { useTrackingQ } from "./tracking-q.api";
import type { TrackingParticipant } from "./tracking-q.types";
...
export default function TrackingQPage() {
  const [page, setPage] = useState(1);
  const { data, isFetching } = useTrackingQ(page);
  ...
  return (
    <DataTableShell
      ...
      emptyTitle={t("trackingQ.emptyTitle")}
      pagination={{
        page,
        totalPages,
        total,
