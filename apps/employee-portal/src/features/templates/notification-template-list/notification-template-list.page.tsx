    ...
    <div className="space-y-4">
      <div className="relative w-full max-w-md">
        ...
        <Input
          ...
          placeholder="Search by name, module, provider…"
      ...
      <DataTableShell
        ...
        header={
          <TableRow className={TABLE_HEADER_ROW_CLASS}>
            ...
            <TableHead className={TABLE_HEAD_CLASS}>Module</TableHead>
            <TableHead className={TABLE_HEAD_CLASS}>Provider</TableHead>
            <TableHead className={TABLE_HEAD_CLASS}>Template ID</TableHead>
            <TableHead className={TABLE_HEAD_CLASS}>Flow ID</TableHead>
