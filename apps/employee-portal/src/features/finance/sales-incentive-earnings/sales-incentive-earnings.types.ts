...
//   SalesEarnings -> craft-frontend/src/pages/IncentiveModule/Earnings.js
...
//
// fetchEstimateList (moduleName === "EMPLOYEE" branch):
//   GET /alpha/v1/finance/estimate?mode=PAYABLE&category=${module.configuration.category}
//       &user_type=EMPLOYEE&associate_id=${employee_id}
