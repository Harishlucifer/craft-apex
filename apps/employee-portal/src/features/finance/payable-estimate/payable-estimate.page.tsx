...
// Legacy: Estimate.js — PAYABLE mode, moduleName !== "EMPLOYEE" (Partner flow).
// Filters mirrored verbatim: Territory Type, Territory, Channel, Month.
// Deferred: legacy EstimateForm "Generate Invoice" button (POST /alpha/v1/finance/payable)
// and the "Earnings"-only summary card variant. See // TODO comments below.
...
export default function PayableEstimatePage() {
  ...
  const { data: payload, isFetching } = usePayableEstimate(
    {
      category,
    ...
    <div className="mx-auto max-w-7xl space-y-5">
      <div>
        ...
        <p className="text-sm text-slate-500">
          Estimate payouts for an approved partner by territory and month.
        </p>
      </div>
        ...
        <CardContent>
          ...
          >
            ...
            <div className="md:col-span-4 flex items-center justify-end gap-2">
              {/* TODO: port legacy "Generate Invoice" button → POST /alpha/v1/finance/payable
                  (Estimate.js onSubmit calls GET_PAYABLE with user_type/associate_id/category/month). */}
              <button
                type="submit"
