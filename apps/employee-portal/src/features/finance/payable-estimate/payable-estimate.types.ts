// Legacy: craft-frontend/src/Components/PayableReceivableManagement/Estimate/Estimate.js
// GET /alpha/v1/finance/estimate?mode=PAYABLE&category=…&user_type=CHANNEL&associate_id=…
//     &territory_id=…&month=…
