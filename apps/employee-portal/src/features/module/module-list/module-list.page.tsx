  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between gap-3">
        <div className="relative w-full max-w-md">
          ...
          <Input
            ...
            placeholder={ts("module.searchPlaceholder")}
        ...
        <PermissionGate action="add">
          <Button asChild>
            <Link to="/settings/module/create">
              <Plus className="h-4 w-4" /> {ts("module.addButton")}
            </Link>
          </Button>
        </PermissionGate>
      </div>
      ...
      <DataTableShell
        ...
        emptyTitle={ts("module.emptyTitle")}
        pagination={{
          page: list.page,
        ...
        header={
          <TableRow className={TABLE_HEADER_ROW_CLASS}>
            ...
            <TableHead className={TABLE_HEAD_CLASS}>{ts("module.colPlatform")}</TableHead>
            <TableHead className={TABLE_HEAD_CLASS}>{tc("name")}</TableHead>
            <TableHead className={TABLE_HEAD_CLASS}>{ts("module.colUrl")}</TableHead>
            <TableHead className={TABLE_HEAD_CLASS}>{ts("module.colParent")}</TableHead>
