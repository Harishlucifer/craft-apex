  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between gap-3">
        <div className="relative w-full max-w-md">
          ...
          <Input
            ...
            placeholder={ts("lender.searchPlaceholder")}
        ...
        <PermissionGate action="add">
          <Button asChild>
            <Link to="/settings/add-lender">
              <Plus className="h-4 w-4" /> {ts("lender.addButton")}
            </Link>
          </Button>
        </PermissionGate>
      </div>
      ...
      <DataTableShell
        ...
        emptyTitle={ts("lender.emptyTitle")}
        pagination={{
          page: list.page,
        ...
        header={
          <TableRow className={TABLE_HEADER_ROW_CLASS}>
            ...
            <TableHead className={TABLE_HEAD_CLASS}>{ts("lender.colLenderType")}</TableHead>
